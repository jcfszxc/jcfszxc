...
#include <set>
#include <vector>
#define LABEL_NALE_TXT_PATH "./models/labels_list.txt"
...
static int process(int8_t *input, int *anchor, int grid_h, int grid_w, [[maybe_unused]] int height, [[maybe_unused]] int width, int stride,
